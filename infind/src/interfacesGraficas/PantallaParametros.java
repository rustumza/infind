...
import interfacesGraficas.Controladores.ControladorParametros;
...
public class PantallaParametros extends javax.swing.JDialog {
    ...
    public PantallaParametros(java.awt.Frame parent, boolean modal, ControladorParametros contr) {
        super(parent, modal);
        initComponents();
        controlador = contr;
    }
...
controlador.guardar();
    ...
    public ControladorParametros getControlador() {
        return controlador;
    }

    public void setControlador(ControladorParametros controlador) {
