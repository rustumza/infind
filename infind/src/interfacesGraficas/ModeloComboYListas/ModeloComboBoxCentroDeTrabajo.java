 ...
 * @author edu
 */
public class ModeloComboBoxCentroDeTrabajo extends DefaultComboBoxModel{
    ...
    public ModeloComboBoxCentroDeTrabajo(ModeloComboBoxCentroDeTrabajo modelo) {
    ...
    public ModeloComboBoxCentroDeTrabajo(ComboBoxModel modelo) {
        addElement("Seleccione un tipo");
    ...
    public List<MaestroDeCentroDeTrabajo> getListaPuesto() {
        return listaPuesto;
    }
