...
import interfacesGraficas.Controladores.ControladorListarProveedores;
 ...
 * @author eduardo
 */
public class PantallaListarProveedores extends javax.swing.JDialog {

    ControladorListarProveedores controlador;

    /** Creates new form PantallaEditarMateriaPrima*/
    public PantallaListarProveedores(java.awt.Frame parent, boolean modal, ControladorListarProveedores controladorProveedores) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Proveedores encontrados"));
        ...
        mostrarMateriasPrimasEliminadasCheckBox.setText("Mostrar proveedores eliminados");
...
private void tablaMateriasPrimasEncontradasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMateriasPrimasEncontradasMouseClicked
    if(evt.getClickCount()==2){
        int matePrimSeleccionada = getTablaProveedores().getSelectedRow();
        controlador.editarProveedores(matePrimSeleccionada);
    }
...
private void mostrarMateriasPrimasEliminadasCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mostrarMateriasPrimasEliminadasCheckBoxActionPerformed
    ...
    public ControladorListarProveedores getControlador() {
        return controlador;
    }

    public void setControlador(ControladorListarProveedores controlador) {
