 ...
 */
@Entity
public class Rentabiliadda extends ObjetoPersitente implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Rentabiliadda)) {
            return false;
        }
        Rentabiliadda other = (Rentabiliadda) object;
    ...
    public String toString() {
        return "Entidades.indices.Rentabiliadda[ id=" + id + " ]";
    }
