 ...
 * @author eduardo
 */
public class ModeloTablaOperariosEncontrados extends ModeloTabla{



    public ModeloTablaOperariosEncontrados() {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
     ...
     public void quitarArticuloLista(Operario operario) {
